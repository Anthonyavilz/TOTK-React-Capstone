...
const { getHelms, getChestArmor, getLegArmor, addArmorSet, getArmorSets, getSelectedHelm } = require('./controllers/armor')
...
app.get('/sets/:id', getArmorSets)
app.get('/helmArmor/:id', getSelectedHelm)
